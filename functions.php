...
require( get_template_directory()  . '/check-product.php');
/**
...
class StarterSite extends Timber\Site {
	...
	public function add_to_context( $context ) {
		...
		$context['options_menu_group_mobile'] = get_fields('options')['menu_group_mobile'];
		$context['options_logo_website'] = get_fields('options')['logo_website'];
		$context['options_f_contact'] = get_fields('options')['f_contact'];
		...
		$context['options_agent_choice'] = get_fields('options')['agent_choice'];
		$context['options_product_check'] = get_fields('options')['product_check'];
		$context['options_hash'] = get_fields('options')['hash'];
...
function set_my_comment_title($arg) {
    $arg['title_reply'] = get_fields('options')['our_review']['form']['title'];
    return $arg;
}
